            ...
            <div class="content">
                ...
                <p>
                    If you are using this repo as part of the interview process for the <a href="https://diegodev.com">DiegoDev Group</a>
                     then know you are not required to complete all tasks, you are not even required to complete a section, just simply complete "what you can" and ensure everything you complete is working correctly before submitting your repo for review.
                </p>
                ...
                <ul class="align-left">
                    ...
                    <li> Go to route <a href="products">/products</a> and tell me specifically what is wrong, if anything, and fix it.
                    <li> Create a resourceful Controller for a object called Review.
                    <li> Add a route that points to your Review Controller and have it return a new blade view.
                ...
                <ul>
                    <li> Sign your commits using a GPG key.
